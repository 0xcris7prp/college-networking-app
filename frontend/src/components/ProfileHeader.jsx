...
const ProfileHeader = ({ userData, onSave, isOwnProfile }) => {
    ...
    //  console.log('authUser:', isOwnProfile);

    const { data: authUser } = useQuery({ queryKey: ["authUser"] });

     const { data: connectionStatus, refetch: refetchConnectionStatus } = useQuery({
        queryKey: ["connectionStatus", userData?._id], // Use optional chaining
    ...
    console.log("getConnectionStatus", getConnectionStatus)
    ...
    //changing img alrady done before
    ...
    return (
        <div className='bg-white shadow rounded-lg mb-6'>
            <div
                ...
                style={{
                    backgroundImage: `url('${editedData.bannerImg?.trim() || userData.bannerImg?.trim() || "/banner.png"}')`,
                }}
            >
                {isEditing && (
            ...
            <div className='p-4'>
                <div className='relative -mt-20 mb-4'>
                    <img
                        ...
                        src={editedData.profilePicture?.trim() || userData.profilePicture?.trim() || "/avatar.png"}
                        alt={userData.name}
                    />
